...
public:
	...
	bool Check();									//Checks falta of data of interfaces of contact
	...
	void SolutionStepInitialCheck();				//Computes the bounding volumes on the initial of the solution step (first computing)
