...
public:
	...
	void Gamma_and_Triad(Matrix* G_p, Matrix* t1_p, Matrix* t2_p, Matrix* n_p, Matrix* G_i, Matrix* t1_i, Matrix* t2_i, Matrix* n_i, Matrix* G_ip, double* phii, double* thi, double* phip, double* thp);				//Calculates diversos vectors associated the surface for a pair of convective coordinates
	...
	double x_fac;												//Factor for representar ovalização in the semi-axis x - default = 1
	double z_fac;												//Factor for representar ovalização in the semi-axis z - default = 1
