...
public:
	Errors();
	~Errors();
	bool CheckErrors();		//Checks errors of inconsistência of the input file and alerta the usuario case encontre

	//Functions individuais for check errors in each a of the itens
	bool CheckSolutions();
	bool CheckNodes();
	bool CheckPoints();
	bool CheckArcs();
