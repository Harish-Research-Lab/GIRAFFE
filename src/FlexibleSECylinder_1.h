...
public:
	...
	void Gamma(double* zeta, double* theta, Matrix* G);						//Position of the surface in the convective coordinates escolhidas
	...
	void GammaIntersectionLine(Matrix* p_PO, Matrix* p_t, double* p_lambda, Matrix* p_c);	//Intersection Gamma with the reta
	double Curvature(double zeta, double theta, Matrix* e_dir);			//Returns the curvature of the surface second certa direction and calculated in certo set of convective coordinates
